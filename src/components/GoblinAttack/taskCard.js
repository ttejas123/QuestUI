const Cardwith = (props) => {
	return(
		<div onClick={() => props.setvisible(!props.visible1)} className="bg-orange-900 cursor-pointer rounded-xl border-2 border-black flex items-center justify-center w-26 h-30 relative">
